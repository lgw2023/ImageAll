...
3. JPEG、PNG、HEIC/HEIF、TIFF、WebP、JPEG 2000、静态 GIF、camera-raw（含富士/Adobe）、SVG、单页 PDF 与单页 PDF 兼容 AI 能进入目录库（ADR-041）；动画 GIF、非 RAW 多帧、多页 PDF/AI、传统非 PDF AI、EPS、SVGZ 与 Live Photo 视频轨不进入支持集；
